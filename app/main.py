...
def webhook_whatsapp(payload: WhatsAppWebhookPayload, session: SessionDep) -> PropertyResponse:
    ...
    return PropertyResponse(
        ...
        baths=property_record.baths,
        notes=property_record.notes,
        status=property_record.status.value if hasattr(property_record.status, "value") else property_record.status,
        assigned_client_id=property_record.assigned_client_id,
    )
